...
Install the \code{apparix} package with \code{sudo apt install apparix} 

Run \code{apparix} in order for it to set up its folders.

Then write \code{apparix --shell-examples} and copy everything except the aliases at the bottom. Paste this in \mintinline{text}{~/.bashrc}
