...
\begin{enumerate}
    ...
    \item Find \code{DIR}, \mintinline{text}{STICKY_OTHER_VARIABLE}, \code{STICKY} and write their corresponding values in the
    ...
    \item Replace the values of \code{DIR}, \mintinline{text}{STICKY_OTHER_VARIABLE}, \code{STICKY} with the copied value of\mintinline{text}{OTHER_WRITABLE}.
